...
function Alert({ children, type = 'info' }: { children: React.ReactNode; type?: 'info' | 'warning' | 'error' | 'success' }) {
  const typeStyles = {
...
function MDXImage({ src, alt, ...props }: { src: string; alt: string; width?: number; height?: number }) {
  return (
    <Image
      src={src}
      alt={alt}
...
export const MDXComponents: MDXComponentsType = {
  ...
  h1: ({ children }) => <h1 className="text-3xl font-bold mb-6 mt-8 scroll-m-20">{children}</h1>,
  h2: ({ children }) => <h2 className="text-2xl font-bold mb-4 mt-8 scroll-m-20">{children}</h2>,
  h3: ({ children }) => <h3 className="text-xl font-bold mb-3 mt-6 scroll-m-20">{children}</h3>,
  h4: ({ children }) => <h4 className="text-lg font-bold mb-2 mt-4 scroll-m-20">{children}</h4>,
  h5: ({ children }) => <h5 className="text-base font-bold mb-2 mt-4 scroll-m-20">{children}</h5>,
  h6: ({ children }) => <h6 className="text-sm font-bold mb-2 mt-4 scroll-m-20">{children}</h6>,
